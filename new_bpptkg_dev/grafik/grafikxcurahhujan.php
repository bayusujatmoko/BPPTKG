                ...
                <td><div class="dropdown">
                  ...
                  <td><div class="dropdown">
                    ...
                    <td><div class="dropdown">
                      ...
                      $sql_huj_kal="SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 2 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit";

                      $sql_huj_ngep="SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 4 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit";

                      $sql_huj_bab="SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 3 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit";

                      $sql_huj_jra="SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 9 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit";

                      $sql_huj_selo="SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 8 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit";
                      ?>
