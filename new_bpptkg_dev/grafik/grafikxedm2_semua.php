    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <table>
            <td><div class="dropdown" >
              ...
              <td><div class="dropdown">
                ...
                <td><div class="dropdown">
                  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="background-color: #ffff; color: #286090; width: 150px; height: 50px; font-size: 12pt;">EDM
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="grafikxedm2_kaliurang.php">Grafik EDM Pos Kaliurang</a></li>
                    </ul>
                  </div></td>
                  <td><div class="dropdown">
                    ...
                    <td><div class="dropdown">
                      ...
                      <div class="x_panel">
                        <center><table>
                          <td><a href="grafikxedm2_semua.php"><button type="button" class="btn btn-success" style="width: 200px; height: 50px; font-size: 16pt;">Semua Pos</button></a></td>
                          <td><a href="grafikxedm2_kaliurang.php"><button type="button" class="btn btn-success" style="width: 200px; height: 50px; font-size: 16pt;">Pos Kaliurang</button></a></td>
                          <td><a href="grafikxedm2_babadan.php"><button type="button" class="btn btn-info" style="width: 200px; height: 50px; font-size: 16pt;">Pos Babadan</button></a></td>
                          <td><a href="grafikxedm2_selo.php"><button type="button" class="btn btn-warning" style="width: 200px; height: 50px; font-size: 16pt;">Pos Selo</button></a></td>
                          <td><a href="grafikxedm2_jrakah.php"><button type="button" class="btn btn-danger" style="width: 200px; height: 50px; font-size: 16pt;">Pos Jrakah</button></a></td>
                        </table></center>
                        <br>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="x_content2">
                            ...
                            <div id="container8" style="width: 100%; height: 300px;"></div>
                            <div id="container9" style="width: 100%; height: 300px;"></div>
                    ...
                    WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 2 and a.refid = 3   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
                  ...
                  INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
                  INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
                  WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 2 and a.refid = 4   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
                  and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
                  ORDER BY c.tanggal DESC LIMIT $nilai_limit
                ) sub ORDER BY tanggal ASC";

                $sql_bab1 = "SELECT * FROM (
                SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
                when (length(vertikal) = 7)
                THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
                when (length(vertikal) = 8)
                ...
                INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
                INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
                WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 3 and a.refid = 5   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
                and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
                ORDER BY c.tanggal DESC LIMIT $nilai_limit
              ) sub ORDER BY tanggal ASC";

              $sql_bab2 ="SELECT * FROM (
              SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
              when (length(vertikal) = 7)
              THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
              when (length(vertikal) = 8)
              ...
              INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
              INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
              WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 3 and a.refid = 6   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
              and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
              ORDER BY c.tanggal DESC LIMIT $nilai_limit
            ) sub ORDER BY tanggal ASC";

            $sql_selo1a = "SELECT * FROM (
            SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
            when (length(vertikal) = 7)
            THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
            when (length(vertikal) = 8)
            ...
            INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
            INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
            WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 8 and a.refid = 39   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
            and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
            ORDER BY c.tanggal DESC LIMIT $nilai_limit
          ) sub ORDER BY tanggal ASC";

          $sql_selo1b ="SELECT * FROM (
          SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
          when (length(vertikal) = 7)
          THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
          when (length(vertikal) = 8)
          ...
          INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
          INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
          WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 8 and a.refid = 9   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
          and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
          ORDER BY c.tanggal DESC LIMIT $nilai_limit
        ) sub ORDER BY tanggal ASC";

        $sql_selo2b ="SELECT * FROM (
        SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
        when (length(vertikal) = 7)
        THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
        when (length(vertikal) = 8)
        ...
        INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
        INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
        WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 8 and a.refid = 10   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
        and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
        ORDER BY c.tanggal DESC LIMIT $nilai_limit
      ) sub ORDER BY tanggal ASC";

      $sql_selo3a ="SELECT * FROM (
      SELECT d.loknama,c.tanggal as tanggal,a.jarak_miring,a.vertikal,a.horizontal,(case
      when (length(vertikal) = 7)
      THEN ROUND( SUBSTRING(vertikal, 1, 1)+SUBSTRING(vertikal, 3, 2)/60+SUBSTRING(vertikal, 6, 2)/3600, 4)
      when (length(vertikal) = 8)
      ...
      INNER JOIN var_laporan c on b.var_laporan_id_laporan = c.id_laporan
      INNER JOIN var_lokasi d on  d.lokid = c.var_lokasi_lokid
      WHERE c.tanggal BETWEEN date_add(CURDATE(), INTERVAL -$nilai_limit DAY) and CURDATE() and a.lokid = 8 and a.refid = 11   and ((length(vertikal) = 8) or (length(vertikal) = 7) or (length(vertikal) = 9))
      and ((length(horizontal) = 8) or (length(horizontal) = 7) or (length(horizontal) = 9)  )
      ORDER BY c.tanggal DESC LIMIT $nilai_limit
    ) sub ORDER BY tanggal ASC";
 ...
 map: {
   ...
   scrollbar: {
    trackBorderColor: '#C0C0C8'
        ...
        title: {
          text: 'Grafik EDM Pos Kaliurang Ref 2'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_kal2);
        ...
        title: {
          text: 'Grafik EDM Pos Kaliurang Ref 3'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_kal3);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Babadan Ref 1b'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_bab1);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Babadan Ref 2b'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_bab2);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Selo Ref 1a'
        },
        ...
        xAxis: {
          categories: [
          <?php  
          $result = mysqli_query($conn, $sql_selo1a);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Selo Ref 1b'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_selo1b);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Selo Ref 2b'
        },
        ...
        xAxis: {
          ...
          $result = mysqli_query($conn, $sql_selo2b);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
        ...
        title: {
          text: 'Grafik EDM Pos Selo Ref 3a'
        },
        ...
        xAxis: {
          categories: [
          <?php
          $result = mysqli_query($conn, $sql_selo3a);
          while ($data = mysqli_fetch_array($result))
          {
            ?>
            '<?php echo $data["tanggal"]?>', <?php
