    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
                      <div class="x_panel">
                        <center><table>
                          <td><a href="grafikxtiltmeter_babadan.php"><button type="button" class="btn btn-info btn-lg">Pos Babadan</button></a></td>
                          <td><a href="grafikxtiltmeter_plawangan.php"><button type="button" class="btn btn-warning btn-lg">Pos Plawangan</button></a></td>
                        </table></center>
                        <br>
                    ...
                    $sql_tilt_babadan = "SELECT * FROM (SELECT * FROM var_tiltmeter WHERE stasiun = 33
        ...
        scrollbar: {
          ...
          xAxis: {
            categories: [
            <?php
            $result = mysqli_query($conn, $sql_tilt_babadan);
