      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">TABEL DATA EDM</span>
                <div class="table-responsive">
                 <table id="datatable" class="table table-striped">
                  <thead>
                   <tr style="background-color: #2A3F54; color:#FFFFFF";>
                     <th data-column-id="waktu">Waktu Ukur</th>
                     <th data-column-id="lokasi">Lokasi</th>
                     <th data-column-id="edmid">Edmid</th>
                     <th data-column-id="tinggi" data-type="numeric">Tinggi Alat</th>
                     <th data-column-id="tekanan" data-type="numeric">Tekanan Udara</th>
                     <th data-column-id="kering" data-type="numeric">Suhu Kering</th>
                     <th data-column-id="basah" data-type="numeric">Suhu Basah</th>
                     <th data-column-id="ppm" data-type="numeric">PPM</th>
                     <th data-column-id="kelembaban" data-type="numeric">Kelembapan</th>
                     <th data-column-id="kode_ref">Kode Ref</th>
                     <th data-column-id="reflektor">Nama Reflektor</th>
                     ...
                     <th data-column-id="link" data-formatter="link" data-sortable="false"  >Tindakan</th>
                   </tr>
                 </thead>
                 ...
                 <tbody>
                  ...
                  while($data=mysqli_fetch_array($query3)){  
                    ...
                    <tr>
                      ...
                      <td>
                        <a id="btn-submit" href="tabelxedm2_edit.php?id_edm=<?php echo $data['id_edm'];?>&id_edm_data=<?php echo $data['id_edm_data'];?>">Edit</a><br><br>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
