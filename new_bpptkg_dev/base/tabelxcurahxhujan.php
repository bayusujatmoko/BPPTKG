...
$query3=mysqli_query($conn,"SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) ORDER BY lap.id_laporan DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">  
                <span class="section">DATA CURAH HUJAN</span>
                <div class="table-responsive">
                 <table id="datatable" class="table table-striped">
                  <thead>
                   <tr style="background-color: #2A3F54; color:#FFFFFF";>
                    <td data-column-id="lokasi" >Nama Lokasi</td>
                    <td data-column-id="mulai">Mulai</td>
                    <td data-column-id="selesai">Selesai</td>
                    <td data-column-id="curah_hujan" data-type="numeric">Curah Hujan</td>
                ...
                <tbody>
                  ...
                  while($data = mysqli_fetch_array($query3)){  
                    ...
                    <td>
                      <a id="btn-submit" href="tabelxcurahxhujan_edit.php?id_hujan=<?php echo $data['id_hujan'];?>">Edit</a><br><br>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
