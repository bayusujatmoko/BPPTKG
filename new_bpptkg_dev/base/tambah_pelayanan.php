						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<table method="POST" class="table">
								<tr><td><label for="noagenda">No Agenda</label></td>
									<td><input type="text" id="noagenda" name="noagenda" class="form-control"></td></tr>
									<tr><td><label>No Surat</label></td>
										<td><input type="text" id="nosurat" name="nosurat" class="form-control"></td></tr>
										<tr><td><label>Tanggal Masuk</label></td>
											<td><input type="date" id="tglmasuk" name="tglmasuk" class="form-control"></td></tr>
											<tr><td><label>Jenis</label></td>
												<td><select id="jenis" name="jenis" class="form-control">
												...
												<tr><td><label>Asal Surat</label></td>
													<td><input type="text" id="asal" name="asal" class="form-control"></td></tr>
													<tr><td><label>Maksud / Acara</label></td>
														<td><input type="text" id="maksud" name="maksud" class="form-control"></td></tr>
													</table>
												</div>
														...
														<tr><td><label>Tgl Pelaksanaan mulai</label></td>
															<td><div class="form-group">
																<div class='input-group date' id='datetimepicker6'>
																	<input name="tglmulai" type='text' class="form-control" />
															...
															<td><div class="form-group">
																<div class='input-group date' id='datetimepicker7'>
																	<input name="tglselesai" type='text' class="form-control" />
																	<span class="input-group-addon">
																		<span class="glyphicon glyphicon-calendar"></span>
																	</span>
																</div>
							...
							<?php
								...
								if($_POST['submit']){
									...
									// $tugas = "Permohonan "+$jenis+" dari "+$asal+" : "+$awal+" s/d "+$akhir+". "+$acara;
									$tug[0] = "Permohonan";
									$tug[1] = $jenis;
									$tug[2] = "dari";
									$tug[3] = $asal;
									...
									foreach ($_POST['petugas'] as $key=>$val) {
										...
										$sql1 = mysqli_query($conn,"INSERT INTO tugas(idpembuat,atasnama,tugas,tglbuat,tgltugas,tglselesai) values ('$pembuat','$pelaksana','$tugas','$intime','$awal','$akhir')");

										$idt = mysqli_query($conn, "SELECT idtugas from tugas order by idtugas desc limit 1");
										if (mysqli_num_rows($idt) > 0) {
											while($row = mysqli_fetch_assoc($idt)) {
												$idtug = $row['idtugas'];
											}
										}
										$idtugas = $idtug;

										$sql = mysqli_query($conn, "INSERT INTO pelayanan(noagenda,nosurat,tglmasuk,asalsurat,maksud,intime,ids,idtugas,jenis,tglmulai,tglselesai) values('$noagenda','$nosurat','$tglmasuk','$asal','$acara','$intime','$pelaksana','$idtugas','$jenis','$awal','$akhir')");
