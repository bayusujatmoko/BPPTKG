...
$id_seismis = $_GET['id_seismisitas'];
$query3=mysqli_query($conn,"SELECT * from var_seismisitas seis join var_laporan lap on (seis.var_laporan_id_laporan=lap.id_laporan) where id_seismisitas = '$id_seismis'");
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">Form Olah Data Seismik</span>
                <form method="post" action="" enctype="multipart/form-data">
                <table class="table">
                  <thead>
                    <tr align="center" style="background-color: #2A3F54; color:#FFFFFF";>
                              <th rowspan="2" style="text-align : center">ID Seismik</th>
                  ...
                  <tbody>
                  <tr>
                    <td><input class="form-control" type="text" name="id_seismis" value="<?= $data['id_seismisitas'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="gempa" value="<?= $data['fenomena_id_fenomena'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="frekuensi" value="<?= $data['frekuensi'];?>" required></td>
                    <td><input class="form-control" type="text" name="amin" value="<?= $data['amin'];?>" required></td>
                      <td><input class="form-control" type="text" name="amax" value="<?= $data['amax'];?>" required></td>
                     <td><input class="form-control" type="text" name="dmin" value="<?= $data['dmin'];?>" required></td>
                     <td> <input class="form-control" type="text" name="dmax" value="<?= $data['dmax'];?>" required></td>
                  </tr>
                </tbody>
              </table>
        ...
        <script type="text/javascript">
          ...
          <?php
            $id_seismis = $_GET['id_seismisitas'];
            if($_POST['update']){
              $frek = $_POST['frekuensi'];
              $amin = $_POST['amin'];
              $amax = $_POST['amax'];
              $dmin = $_POST['dmin'];
              $dmax = $_POST['dmax'];
              $q =mysqli_query($conn,"UPDATE var_seismisitas set frekuensi ='$frek', amin='$amin', amax='$amax', dmin='$dmin', dmax='$dmax' where id_seismisitas='$id_seismis'");
              if ($q){
                echo "<script>alert('Data berhasil diubah !'); window. location = 'tabelxseismis.php'</script>";
              } else {
                echo "<script>alert('Gagal !'); history.go(-1)</script>";
              }
            }else if($_POST['hapus']){
              $q = mysqli_query($conn,"DELETE from var_seismisitas where id_seismisitas='$id_seismis'");
              if ($q){
                echo "<script>alert('Data berhasil dihapus !'); window.location = 'tabelxseismis.php'</script>";
              }else {
                echo "<script>alert('Gagal !'); history.go(-1)<script>";
              }
            }
