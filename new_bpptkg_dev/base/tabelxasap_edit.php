...
$id_asaps = $_GET['id_asaps'];
$query3=mysqli_query($conn,"SELECT * from var_asaps asaps join var_laporan lap on (asaps.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where id_asaps = '$id_asaps'");
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">Form Olah Data Asap Solfatara</span>
                ...
                <table class="table">
                  ...
                  <tbody>
                      <td><input class="form-control" type="text" name="iddata" value="<?= $data['id_asaps'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="lokasi" value="<?= $data['loknama'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="tanggal" value="<?= $data['tanggal'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="warna" value="<?= $data['warna'];?>" required></td>
                    <td><input class="form-control" type="text" name="tekanan" value="<?= $data['tekanan_asap'];?>" required></td>
                    <td> <input class="form-control" type="text" name="intensitas" value="<?= $data['intensitas'];?>" required></td>
                    <td><input class="form-control" type="text" name="tinggi_asap" value="<?= $data['tinggi_asap'];?>" required>
                    </td>
                    </tbody>
                  </table>
          ...
          <?php
            ...
            if($_POST['update']){
              ...
              $tinggi = $_POST['tinggi_asap'];
              $q =mysqli_query($conn,"UPDATE var_asaps set warna ='$warna', tekanan_asap='$tekanan', intensitas='$intensitas', tinggi_asap='$tinggi' where id_asaps='$id_asaps'");
              if ($q){
                echo "<script>alert('Data berhasil diubah !'); window. location = 'tabelxasap.php'</script>";
              } else {
                echo "<script>alert('Gagal !'); history.go(-1)</script>";
              }
            }else if($_POST['hapus']){
              $q = mysqli_query($conn,"DELETE from var_asaps where id_asaps='$id_asaps'");
              if ($q){
                echo "<script>alert('Data berhasil dihapus !'); window.location = 'tabelxasap.php'</script>";
              }else {
                echo "<script>alert('Gagal !'); history.go(-1)<script>";
              }
            }
