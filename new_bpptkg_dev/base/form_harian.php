          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <h2><?php while($nama=mysqli_fetch_array($query1)) { ?>
                  <?= $nama['fullname'];?>
                  <?php } ?>
                </h2>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt=""><?php while($nama=mysqli_fetch_array($query2)) { ?>
                  <?= $nama['fullname'];?>
                  <?php } ?>
                ...
                <div class="x_panel">
                  ...
                  <form method="post" action="proses/insert_laporan_harian.php" class="dropzone" id="formharian" enctype="multipart/form-data">
                    <table class="table table-borderless">
                      ...
                      <?php
                      $idl = $_GET['id_laporan'];
                      $sql1=mysqli_query($conn,"SELECT lap.tanggal, lap.keterangan, lok.loknama, lap.var_lokasi_lokid, lap.var_lokasi_lokid from var_lokasi lok join var_laporan lap on (lok.lokid = lap.var_lokasi_lokid) where lap.id_laporan='$idl'");
                      while($dat1 = mysqli_fetch_array($sql1)){
                        $lok = $dat1['var_lokasi_lokid'];
                        ?>
                        <tr>
                          <td>Nama Pos</td>
                          <td><?= $dat1['loknama'];?></td>
                  ...
                  <div class="x_content">
                    ...
                    <div id="wizard_verticle" class="form_wizard wizard_verticle">
                          ...
                          <div id="step-11">
                            ...
                            <script type="text/javascript">
                              function add_foto() {
                                ...
                                content +='<td><input type="hidden" class="form-control" id="gl2" name="idfvdt_[]" value="<?= $datetime; ?>"></td>';
                                content +='</tbody>';
                                content +='</table>';
                                ...
                                content +='<table class="table">';
                            		...
                            		content +='<tbody>';
                            			content +='<td><select class="form-control" id="dp0" name="reflektor_de[]">';
                                          <?php 
                              				$sqlqr=mysqli_query($conn,"SELECT * FROM instrumen where idjenis = 2");
                              				while ($data = mysqli_fetch_assoc($sqlqr)) {                                                          
                             				?>
                                         content+='<option value="<?=$data["idinstrumen"];?>"><?=$data['kode']?></option>';                                          
                                          <?php 
                                          }
                                           ?>                                        
                            			content +='</select></td>';
                                  ...
                                  content +='<td><input type="hidden" name="lokidedm[]" value="<?=$lok;?>"></td>';
                        			content +='</tbody>';
                      			content +='</table>';
                          ...
                          content += '</table>';
                            ...
                            <div class="x_panel">
                              ...
                              <tbody>
                                ...
                                <td><input type="hidden" class="form-control" id="gl2" name="idfvdt_[]" value='<?= $datetime; ?>'></td>
                        ...
                        <div id="step-33">
                          ...
                          <table class="table">
                            <thead>
                              <tr>
                                ...
                                <th><label for="ta1">Tinggi Alat(cm)</label></th>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class='input-group date' id='myDatepicker'>
                                        <input type='text' class="form-control" name="waktu_edm" />
                          ...
                          <p><label class="StepTitle">Data Pengukuran : </label></p>
                            ...
                            <select class="form-control" id="as4" name="reflektor_de[]">
                              ...
                              while ($data = mysqli_fetch_assoc($sqlqr)) {                                                          
                             ?>
                                         <option value='<?=$data['idinstrumen'] ?>'><?=$data['kode']?></option>                                          
                                          <?php 
                                          }
                                           ?>
                                        </select>
                            ...
                            <td><input type="hidden" name="lokidedm[]" value='<?=$lok;?>'></td>
                        </tbody>
                      </table>
                      <a href="javascript:add_dp();"><b>Tambah record</b></a>
                          ...
                          <td><input type="hidden" class="form-control" id="gl2" name="dttm" value='<?= $datetime; ?>'></td>
                          <br>
                          ...
                          <td><input type="hidden" class="form-control" id="gl2" name="idlgps" value='<?= $idl; ?>'></td>
                           <td><input type="hidden" class="form-control" id="gl2" name="dtgps" value='<?= $datetime; ?>'></td>
                           <td><input type="hidden" class="form-control" id="gl2" name="logps" value='<?= $loklok; ?>'></td>
                          <br>
                          <label>Data Pengukuran</label>
                          <table class="table">
                            <thead>
                          ...
                          <div id="step-55">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <textarea name="text_lain" class="test"></textarea>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                ...
                                <div class="x_content">
                                  ...
                                  <textarea name="text_kes" class="test"></textarea>
                          ...
                          <div id="step-77">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                ...
                                <div class="x_content">
                                  <textarea name="text_rek" class="test"></textarea>
