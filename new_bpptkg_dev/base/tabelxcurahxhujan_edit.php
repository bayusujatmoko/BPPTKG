...
$query3=mysqli_query($conn,"SELECT * from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where id_hujan = '$id_hujan'");
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">Form Olah Data Curah Hujan</span>
                ...
                <table class="table">
                  ...
                  <tbody>
                  <tr>
                    <td><input class="form-control" type="text" name="idhujan" value="<?= $data['id_hujan'];?>" 
                      readonly></td>
                    <td><input class="form-control" type="text" name="lokasi" value="<?= $data['loknama'];?>" 
                      readonly></td>
                    <td><input class="form-control" type="text" name="tanggal" value="<?= $data['tanggal'];?>" 
                      readonly></td>
                    <td><input class="form-control" type="text" name="mulai" value="<?= $data['waktu_mulai'];?>" 
                      required></td>
                    <td><input class="form-control" type="text" name="selesai" value="<?= $data['waktu_reda'];?>" required></td>
                    <td><input class="form-control" type="text" name="curah" value="<?= $data['curah'];?>" 
                      required> </td>
                    </tr>
                  </tbody>
                  </table>
                      <label>Untuk pemisah waktu menggunakan simbol titik dua (:)</label><br>
        ...
        if($_POST['update']){
          ...
          $curah = $_POST['curah'];
          $q =mysqli_query($conn,"UPDATE var_hujan set waktu_mulai ='$mulai', waktu_reda='$selesai', curah='$curah' where id_hujan='$id_hujan'");
          if ($q){
            echo "<script>alert('Data berhasil diubah !'); window. location = 'tabelxcurahxhujan.php'</script>";
          } else {
            echo "<script>alert('Gagal !'); history.go(-1)</script>";
          }
        }else if($_POST['hapus']){
          $q = mysqli_query($conn,"DELETE from var_hujan where id_hujan='$id_hujan'");
          if ($q){
            echo "<script>alert('Data berhasil dihapus !'); window.location = 'tabelxcurahxhujan.php'</script>";
          }else {
            echo "<script>alert('Gagal !'); history.go(-1)<script>";
          }
        }
