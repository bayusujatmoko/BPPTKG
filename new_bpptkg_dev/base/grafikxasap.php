...
//tickInterval: 30*60*1000
    ...
    series: [
    {
      ...
      while ($data = mysqli_fetch_array($result)) {
        ...
        ?>
        [<?php echo strtotime($data["tanggal"] . " Asia/Jakarta") * 1000 ?>, <?php echo $value ?>], <?php
      }?>
      ],
      tooltip: {
        valueSuffix: ' '
      ...
      },
      {
        ...
        while ($data = mysqli_fetch_array($result)) {
          ?>
          [<?php echo strtotime($data["tanggal"] . " Asia/Jakarta") * 1000 ?>, <?php echo $data["tinggi_asap"] ?>], <?php
        }?>
        ],
        tooltip: {
          valueSuffix: ' Meter'
