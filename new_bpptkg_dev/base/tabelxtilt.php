...
$query3=mysqli_query($conn,"SELECT * from var_tiltmeter tilt join var_laporan lap on (tilt.var_laporan_id_laporan=lap.id_laporan) join instrumen ins on (ins.idinstrumen = tilt.stasiun) ORDER BY lap.id_laporan DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">TABEL DATA TILTMETER</span>
                <div class="table-responsive">
                 <table id="datatable" class="table table-striped">
                  <thead>
                   <tr style="background-color: #2A3F54; color:#FFFFFF";>
                     <th data-column-id="lokasi">Nama Pos</th>
                     <th data-column-id="us">US</th>
                     <th data-column-id="bt">BT</th>
                     <th data-column-id="suhu" data-type="numeric">Suhu</th>
                     <th data-column-id="inserttime">Waktu Input</th>
                 ...
                 <tbody>
                  ...
                  while($data=mysqli_fetch_array($query3)){  
                    ...
                    <tr>
                     ...
                     <td>
                      <a id="btn-submit" href="tabelxtilt_edit.php?id_tiltmeter=<?php echo $data['id_tiltmeter'];?>">Edit</a><br><br>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
