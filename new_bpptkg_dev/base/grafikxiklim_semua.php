...
<div class="right_col" role="main">
							<div class="x_panel">
								<center><table>
									<td><a href="grafikxiklim_semua.php"><button type="button" class="btn btn-danger btn-lg">Semua Pos</button></a></td>
									<td><a href="grafikxiklim_kaliurang.php"><button type="button" class="btn btn-success btn-lg">Pos Kaliurang</button></a></td>
										<td><a href="grafikxiklim_babadan.php"><button type="button" class="btn btn-info btn-lg">Pos Babadan</button></a></td>
										<td><a href="grafikxiklim_selo.php"><button type="button" class="btn btn-warning btn-lg">Pos Selo</button></a></td>
										<td><a href="grafikxiklim_jrakah.php"><button type="button" class="btn btn-danger btn-lg">Pos Jrakah</button></a></td>
										<td><a href="grafikxiklim_ngepos.php"><button type="button" class="btn btn-success btn-lg">Pos Ngepos</button></a></td>
										<td><a href="grafikxiklim_monitoring.php"><button type="button" class="btn btn-info btn-lg">Ruang monitoring</button></a></td>
									</table></center>
									<br>
								...
								$sql_iklim_monitoring = "SELECT * FROM  (SELECT CONCAT(lap.tanggal,' ',iklim.jam) as waktu, iklim.suhu, iklim.kec_angin as kec, iklim.kelembaban as humidity, iklim.tekanan_udara as pressure, lok.loknama as lokasi from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lok.lokid = 1 order by waktu desc limit $nilai_limit) sub ORDER BY waktu ASC";

								$sql_iklim_kaliurang = "SELECT * FROM  (SELECT CONCAT(lap.tanggal,' ',iklim.jam) as waktu, iklim.suhu, iklim.kec_angin as kec, iklim.kelembaban as humidity, iklim.tekanan_udara as pressure, lok.loknama as lokasi from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lok.lokid = 2 order by waktu desc limit $nilai_limit) sub ORDER BY waktu ASC";
								...
								$sql_iklim_selo = "SELECT * FROM  (SELECT CONCAT(lap.tanggal,' ',iklim.jam) as waktu, iklim.suhu, iklim.kec_angin as kec, iklim.kelembaban as humidity, iklim.tekanan_udara as pressure, lok.loknama as lokasi from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lok.lokid = 8 order by waktu desc limit $nilai_limit) sub ORDER BY waktu ASC";

								$sql_iklim_jrakah = "SELECT * FROM  (SELECT CONCAT(lap.tanggal,' ',iklim.jam) as waktu, iklim.suhu, iklim.kec_angin as kec, iklim.kelembaban as humidity, iklim.tekanan_udara as pressure, lok.loknama as lokasi from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lok.lokid = 9 order by waktu desc limit $nilai_limit) sub ORDER BY waktu ASC";

								$sql_iklim_ngepos = "SELECT * FROM  (SELECT CONCAT(lap.tanggal,' ',iklim.jam) as waktu, iklim.suhu, iklim.kec_angin as kec, iklim.kelembaban as humidity, iklim.tekanan_udara as pressure, lok.loknama as lokasi from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lok.lokid = 4 order by waktu desc limit $nilai_limit) sub ORDER BY waktu ASC";
								...
								Highcharts.chart('container', {
									...
									xAxis: [{
										categories: [
										<?php
										$result = mysqli_query($conn, $sql_iklim_kaliurang);
		...
		crosshair: true
								...
								Highcharts.chart('container3', {
									...
									xAxis: [{
										categories: [
										<?php
										$result = mysqli_query($conn, $sql_iklim_selo);
										while ($data = mysqli_fetch_array($result)){
											?>
											'<?php echo $data["waktu"]?>', <?php
										}?>
									...
									xAxis: [{
										categories: [
										<?php
										$result = mysqli_query($conn, $sql_iklim_jrakah);
										while ($data = mysqli_fetch_array($result)){
											?>
											'<?php echo $data["waktu"]?>', <?php
										}?>
								...
								Highcharts.chart('container5', {
									...
									xAxis: [{
										categories: [
										<?php
										$result = mysqli_query($conn, $sql_iklim_ngepos);
										while ($data = mysqli_fetch_array($result)){
											?>
											'<?php echo $data["waktu"]?>', <?php
										}?>
								...
								Highcharts.chart('container6', {
									...
									xAxis: [{
										categories: [
										<?php
										$result = mysqli_query($conn, $sql_iklim_monitoring);
										while ($data = mysqli_fetch_array($result)){
											?>
											'<?php echo $data["waktu"]?>', <?php
										}?>
