...
$id_analisis_kimia = $_GET['id_analisis_kimia'];
$query3=mysqli_query($conn,"SELECT * FROM analisis_kimia where id_analisis_kimia = '$id_analisis_kimia'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">Form kimia edit</span>
        <form  method="post" action="proses/edit_delete_kimia.php" class="dropzone" enctype="multipart/form-data">
           ...
           <tr>
             <?php 
              while ($row=mysqli_fetch_array($query3)){       
                ...
                echo "<td>".$row['H2O']."</td>";
                echo "<td>".$row['suhu']."</td>";
                echo "<td><input type='hidden' class='form-control' id='gl2' name='idak' value=".$row['id_analisis_kimia']."></td>";
                echo "</tr>";
               }
         ?>
           </tr>
        <tr>
              ...
              <td><input type="text" class="form-control" id="k14" name="suhu"></td>
                    ...
                    <center>
                      <input class="btn btn-primary" name="update" type="submit" value="Submit" onclick="return klikUbah();">
