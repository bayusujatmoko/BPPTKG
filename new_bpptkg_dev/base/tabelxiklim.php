...
$query3=mysqli_query($conn,"SELECT * from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) ORDER BY lap.id_laporan DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">TABEL DATA IKLIM</span>
                 ...
                 <table id="datatable" class="table table-striped">
                  <thead>
                   <tr style="background-color: #2A3F54; color:#FFFFFF";>
                     ...
                     <th data-column-id="suhu" data-type="numeric">Suhu</th>
                     <th data-column-id="arah">Arah Angin</th>
                     <th data-column-id="kecepatan" data-type="numeric">Kecepatan Angin</th>
                     <th data-column-id="Kelembapan" data-type="numeric">Kelembapan</th>
                     <th data-column-id="tekanan" data-type="numeric">Tekanan</th>
                 ...
                 <tbody>
                  ...
                  while($data=mysqli_fetch_array($query3)){  
                    ...
                    <tr>
                      ...
                      <td>
                        <a id="btn-submit" href="tabelxiklim_edit.php?id_klimatologi=<?php echo $data['id_klimatologi'];?>">Edit</a><br><br>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
