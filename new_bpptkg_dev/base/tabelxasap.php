...
$query3=mysqli_query($conn,"SELECT * from var_asaps asaps join var_laporan lap on (asaps.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) ORDER BY lap.id_laporan DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <span class="section">TABEL DATA ASAP</span>
                <table id="datatable" class="table table-striped">
                  <thead>
                   <tr style="background-color: #2A3F54; color:#FFFFFF";>
                     <td data-column-id="tanggal">Tanggal</td>
                     <td data-column-id="lokasi">Lokasi</td>
                     <td data-column-id="warna">Warna</td>
                     <td data-column-id="intensitas">Intensitas</td>
                     <td data-column-id="tekanan" >Tekanan</td>
                     <td data-column-id="tinggi" data-type="numeric">Tinggi</td>
                     <td data-column-id="link" data-formatter="link" data-sortable="false">Tindakan</td>
                   </tr>
                 </thead>
                 ...
                 <tbody>
                  ...
                  while($data = mysqli_fetch_array($query3)){  
                    ...
                    <tr>
                     ...
                     <td>
                        <a id="btn-submit" href="tabelxasap_edit.php?id_asaps=<?php echo $data['id_asaps'];?>">Edit</a><br><br>
                      </td>
                    </td>
                  </tr>
                  <?php } ?>
