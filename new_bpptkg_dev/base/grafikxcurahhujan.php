    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
                      ...
                      $sql_huj_kal="SELECT * FROM (SELECT hujan.curah, lap.tanggal from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 2 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit) sub ORDER BY tanggal ASC";

                      $sql_huj_ngep="SELECT * FROM (SELECT hujan.curah, lap.tanggal from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 4 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit) sub ORDER BY tanggal ASC";

                      $sql_huj_bab="SELECT * FROM (SELECT hujan.curah, lap.tanggal from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 3 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit) sub ORDER BY tanggal ASC";

                      $sql_huj_jra="SELECT * FROM (SELECT hujan.curah, lap.tanggal from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 9 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit) sub ORDER BY tanggal ASC";

                      $sql_huj_selo="SELECT * FROM (SELECT hujan.curah, lap.tanggal from var_hujan hujan join var_laporan lap on (hujan.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where lap.var_lokasi_lokid = 8 ORDER BY lap.id_laporan DESC LIMIT $nilai_limit ) sub ORDER BY tanggal ASC";
                      ?>
       ...
       scrollbar: {
        trackBorderColor: '#C0C0C8'
            ...
            // Grafik curah hujan pos kaliurang
            ...
            title: {
              text: 'Curah Hujan Pos Kaliurang'
            },
            ...
            xAxis: {
              categories: [
              <?php
              $result = mysqli_query($conn,$sql_huj_kal);
           ...
           responsive: {
            ...
            Highcharts.chart('container2', {
             ...
             xAxis: {
               categories: [
               <?php
               $result = mysqli_query($conn, $sql_huj_ngep);
               while ($data = mysqli_fetch_array($result))
               {
                 ?>
                 '<?php echo $data["tanggal"]?>', <?php
            ...
            xAxis: {
              categories: [
              <?php
              $result = mysqli_query($conn, $sql_huj_bab);
              while ($data = mysqli_fetch_array($result))
              {
                ?>
                '<?php echo $data["tanggal"]?>', <?php
           ...
           responsive: {
            ...
            Highcharts.chart('container4', {
             ...
             xAxis: {
               categories: [
               <?php
               $result = mysqli_query($conn,$sql_huj_selo);
               while ($data = mysqli_fetch_array($result))
               {
                 ?>
                 '<?php echo $data["tanggal"]?>', <?php
            ...
            xAxis: {
              categories: [
              <?php
              $result = mysqli_query($conn, $sql_huj_jra);
              while ($data = mysqli_fetch_array($result))
              {
                ?>
                '<?php echo $data["tanggal"]?>', <?php
