...
$id_iklim = $_GET['id_klimatologi'];
$query3=mysqli_query($conn,"SELECT * from var_klimatologi iklim join var_laporan lap on (iklim.var_laporan_id_laporan=lap.id_laporan) join var_lokasi lok on (lok.lokid = lap.var_lokasi_lokid) where id_klimatologi = '$id_iklim'");
      ...
      <div class="col-md-3 left_col">
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                 <span class="section">Form Olah Data Iklim</span>
                 ...
                 <table class="table">
                  ...
                  <tbody>
                  <tr>
                    <td><input class="form-control" type="text" name="id_iklim" value="<?= $data['id_klimatologi'];?>" readonly>
                    </td>
                    <td><input class="form-control" type="text" name="lokasi" value="<?= $data['loknama'];?>" readonly> </td>
                    <td><input class="form-control" type="text" name="jam" value="<?= $data['jam'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="waktu" value="<?= $data['waktu'];?>" readonly></td>
                    <td><input class="form-control" type="text" name="suhu" value="<?= $data['suhu'];?>" required></td>
                    <td><input class="form-control" type="text" name="arah" value="<?= $data['arah_angin'];?>" required></td>
                    <td><input class="form-control" type="text" name="kecepatan" value="<?= $data['kec_angin'];?>" required></td>
                    <td><input class="form-control" type="text" name="kelembaban" value="<?= $data['kelembaban'];?>"  required></td>
                    <td><input class="form-control" type="text" name="tekanan" value="<?= $data['tekanan_udara'];?>"  required></td>
                  </tr>
                    </tbody>
                  </table>
        ...
        if($_POST['update']){
          ...
          $q =mysqli_query($conn,"UPDATE var_klimatologi set suhu ='$suhu', arah_angin='$arah', kec_angin='$kecepatan', kelembaban='$kelembaban', tekanan_udara = '$tekanan' where id_klimatologi='$id_iklim'");
          if ($q){
            echo "<script>alert('Data berhasil diubah !'); window. location = 'tabelxiklim.php'</script>";
          } else {
            echo "<script>alert('Gagal !'); history.go(-1)</script>";
          }
        }else if($_POST['hapus']){
          $q = mysqli_query($conn,"DELETE from var_klimatologi where id_klimatologi='$id_iklim'");
          if ($q){
            echo "<script>alert('Data berhasil dihapus !'); window.location = 'tabelxiklim.php'</script>";
          }else {
            echo "<script>alert('Gagal !'); history.go(-1)<script>";
          }
        }
