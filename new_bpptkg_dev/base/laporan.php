  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
              ...
              if ($editdata == "bisa") {                              
              ?>
              <a href="proses/delete_laporan_harian.php?id_laporan=<?=$idldelap;?>"><button type="button" class="btn btn-danger" onclick="return klikHapus();">DELETE LAPORAN</button><!-- buatin javascript peringatan delete nya-->
              </a>
              <?php } ?>
                  <!-- baris 1  -->
                    <div class="row">
                  ...
                  <!-- end modals -->
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="box_kustom col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div id="myCarousel" class="carousel slide box-gambar" data-ride="carousel" style="width:200px;height:180px;margin-top:10px;">
                                          <!-- Wrapper for slides -->
                                          <div class="carousel-inner"> 
                                            <div class="item active">
                                              <img class="image" src="images/inbox.png" alt="images/inbox.png" style="width:100%;height:180px;">
                                              <div class="overlay">
                                                <div style="color: white;font-size: 20px;position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);-ms-transform: translate(-50%, -50%);text-align: center;">Geser Untuk Melihat Foto</div>
                                              </div>
                                            </div>
                                            <?php
                                              $idl = $_GET['id_laporan'];
                                            ...
                                            ?>
                                            <div class="item">
                                              <img class="image" src="images/var_foto_visual/<?= $data['gambar']; ?>" alt="images/inbox.png" style="width:100%;height:180px;">
                                              <div class="overlay">
                                                <div class="text">
                                                  Diambil Pada : <?= $data['waktu'];?><br>
                                                  Lokasi Foto  : <?= $data['lokasi'];?><br>
                                                  Fotografer   : <?= $data['fotografer'];?><br>
