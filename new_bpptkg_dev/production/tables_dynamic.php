...
$sql1=mysqli_query($conn,"SELECT lap.id_laporan, lap.tanggal, lap.keterangan, lok.loknama from var_lokasi lok join var_laporan lap on (lok.lokid = lap.var_lokasi_lokid)");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <?php 
                  $i = 1;
                  while($dat1 = mysqli_fetch_array($sql1) and $nama=mysqli_fetch_array($query3)){  
                ?>
                  <tr>
                    <td><?= $i;?></td>
                    <td>
                    ...
                    <td>
                      <a id="btn-submit" href="form_harian.php?id_laporan=<?php echo $dat1['id_laporan']; ?>">Edit</a><br><br>
                    </td>
                  </tr>
                  <?php $i++; } ?>
                </tbody>
